...
const BrazilFlag: React.FC<BlogProps> = ({ size = 960, className = "" }) => {
  return (
    <svg
      width={size || "960"}
      height={size || "960"}
    ...
    >
      <g clipPath="url(#clip0_510_1402)">
        ...
        />
        <path
          d="M652.68 828.372L626.063 833.158V776.727L507.478 781.342C507.446 781.332 507.411 781.332 507.378 781.342L471.158 782.76C477.141 728.511 480.781 630.882 481.143 602.123C481.233 595.265 478.9 590.097 475.009 586.175L668.648 573.375L657.164 756.775L652.68 828.372Z"
          className="fill-primary"
        />
        <path
          d="M481.142 602.124C480.78 630.883 477.142 728.512 471.157 782.761L78.8115 798.025V880.008H54.3115L40.4805 614.895L475.008 586.176C478.9 590.101 481.232 595.266 481.142 602.124Z"
          className="fill-primary"
        />
        <path
        ...
        />
        <path
          d="M375.852 327.821C376.435 328.213 388.522 336.388 384.137 345.177C379.643 354.166 367.526 338.43 367.526 338.43H367.516C368.25 328.263 368.783 315.664 369.135 305.186C369.517 314.638 386.983 314.886 386.983 322.934C386.983 330.757 376.435 327.982 375.852 327.821Z"
          className="fill-primary"
        />
        <path
        ...
        />
        <path
          d="M230.701 262.479L234.612 288.03L228.438 288.382L212.49 289.277L203.018 289.81L206.567 262.479H230.701Z"
          className="fill-primary"
        />
        <path
          d="M178.171 510.377C175.335 517.717 154.419 523.409 129.049 523.409C104.303 523.409 83.8004 517.989 80.1804 510.909L79.6074 508.666C79.6074 500.521 101.739 493.915 129.049 493.915C137.043 493.883 145.026 494.495 152.921 495.745C168.175 498.259 178.502 503.106 178.502 508.666L178.171 510.377Z"
          className="fill-primary"
        />
        <path
          d="M174.591 528.759L163.391 586.347C163.391 591.576 149.091 595.809 131.455 595.809C113.819 595.809 99.5077 591.576 99.5077 586.347L95.5077 570.701H95.4977L87.0917 537.859L85.1207 530.197L80.1797 510.911C83.7997 517.99 104.303 523.411 129.049 523.411C154.419 523.411 175.335 517.719 178.171 510.379L174.591 528.759Z"
          className="fill-primary-foreground"
          fillOpacity="0.96"
        />
        <path
